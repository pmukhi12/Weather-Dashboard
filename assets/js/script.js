window.addEventListener('load', function () {
    ...
    if (citiesStored && citiesStored.length > 0) {
        citiesStored.forEach(element => displayCities(element))
    }
